...
include 'db.php';  // Make sure this file exists and correctly sets up $conn
        ...
        <?php if ($latest_announcement): ?>
            <div class="announcement-box">
                ...
                <div class="announcement-content">
                    ...
                    <p class="text-sm text-gray-500">Date: <?php echo htmlspecialchars($latest_announcement['AnnouncementDates']); ?></p>
                </div>
            </div>
        <?php else: ?>
