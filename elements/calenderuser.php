...
$sql_events = "SELECT e.*, p.PriestName, sr.Status AS SacramentStatus 
...
if ($stmt_events = $conn->prepare($sql_events)) {
    if ($stmt_events->execute()) {
        ...
        while ($row = $result_events->fetch_assoc()) {
            // Determine event display status based on Sacrament Status
            if ($row['SacramentStatus'] === 'Pending') {
                ...
                $row['DisplayStatus'] = 'Available'; // Default to available if no sacrament status
            }
            $events[] = $row;
        }
    }
...
/* FullCalendar Theme Enhancements */
.fc {
    font-family: 'Gotham', sans-serif;
}
...
.fc-daygrid-event:hover {
    ...
    box-shadow: 0 4px 8px rgba(0, 0, 0, 0.15);
        ...
        .event-list {
            ...
            max-height: 400px; /* Add maximum height to the event list */
...
<div class="flex">
 ...
 <div class="p-6 max-w-7xl mx-auto">
        ...
        <p class="mb-6 text-lg leading-relaxed text-gray-800 bg-gray-100 p-4 rounded-lg shadow-sm border border-gray-300">
            ...
            You can view the event details for any day in the calendar, and the list on the right shows all upcoming scheduled events. Stay informed about upcoming sacraments, blessings, and other parish activities!
        </p>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
            ...
            <div class="event-list">
                ...
                <?php
                // Group events by sacrament type
                $grouped_events = [];
                ...
                if (!empty($grouped_events)):
                    foreach ($grouped_events as $sacrament_type => $sacrament_events): ?>
                        <h5 class="text-lg font-semibold mt-4 mb-2"><?php echo htmlspecialchars($sacrament_type); ?></h5>
                        ...
                        <?php foreach ($sacrament_events as $event): ?>
                            <div class="event-item">
                                ...
                                <div class="event-details">
                                    ...
                                    <span style="
                                        color: <?php 
                                            echo ($event['DisplayStatus'] === 'Available') ? 'blue' : 
...
<script>
    document.addEventListener("DOMContentLoaded", function() {
        ...
        var calendarEvents = events.map(function(event) {
            return {
                title: event.SacramentType + ' - ' + event.PriestName,
